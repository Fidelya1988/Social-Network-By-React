...
class ProfilePhoto extends React.Component  {
  ...
  const isPhotoPresent = this.props.smallPhoto
   ...
   <div className={styles.photo} onClick={this.setCurrentProfilePhoto}>
    ...
    {isPhotoPresent?
     this.state.isPhotoSmall? <img className={styles.smallPhoto} src={this.props.smallPhoto} alt='small-photo' />
        : <img className={styles.largePhoto} src={this.props.largePhoto} alt='large-photo' />
